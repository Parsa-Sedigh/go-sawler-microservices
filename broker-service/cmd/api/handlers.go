...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// The request url is whatever we named the auth service in our docker-compose.yaml which is authentication-service
	...
	if response.StatusCode == http.StatusUnauthorized {
		...
		log.Println("error is: ", response.Body)
		fmt.Println("errrr: ", err)
		app.errorJSON(w, errors.New("error calling auth service"))
		return
	}

	// create a variable that will read response.Body
